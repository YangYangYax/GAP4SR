...
class GCL4SR_Train(Trainer):
    ...
    #
    #             # 获取 train_matrix 的大小
    #             num_users, num_items = self.args.train_matrix.shape
    #             # print(num_users)
    #             # print(num_items)
    #
    #             # 确保 batch_user_index 中的索引不超过用户数的范围;
    #             print(batch_user_index)
    #             batch_user_index = batch_user_index[batch_user_index < num_users]
    #             # print(batch_user_index)
    #
    #             # 先将稀疏矩阵转换为稠密矩阵 总共有440个数据，其他的都没问题，只有295有问题，因此我对混淆矩阵进行了输出，发现只有127个数
    #             train_matrix_dense = self.args.train_matrix.toarray()
    #
    #             # 将 train_matrix_dense 中小于等于0的值设置为 0
    #             #  train_matrix_dense[train_matrix_dense <= 0] = 0
    #             print((train_matrix_dense[batch_user_index] >= 0))  # 查看布尔索引的数量
    #             print(train_matrix_dense[batch_user_index].shape)
    #
    #             # 使用稠密矩阵进行索引
    #             rating_pred[train_matrix_dense[batch_user_index] >= 0] = 0
    #
    #             # 参考：https://stackoverflow.com/a/23734295, https://stackoverflow.com/a/20104162
